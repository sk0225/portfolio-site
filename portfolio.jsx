  ...
  achievements: [
    {
      ...
      description:
        "Awarded first position in a competitive hackathon for an innovative tech solution.",
      icon: "🏆",
    ...
    },
    {
      ...
      description:
        "Elected as Class Representative, demonstrating leadership and communication skills.",
      icon: "🎖️",
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled
        ? "bg-[#050816]/90 backdrop-blur-xl border-b border-white/5 shadow-2xl"
        : "bg-transparent"
        }`}
    >
...
function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#050816] px-6"
    >
      {/* Animated background orbs */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-[#915eff]/20 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#3b82f6]/15 rounded-full blur-[140px] animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        {/* Name */}
        <h1
          className={`text-5xl md:text-7xl font-black text-white tracking-tight leading-none mb-4 transition-all duration-700 delay-100 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
        >
          Hi, I'm{" "}
        ...
        {/* Tagline */}
        <p
          className={`text-base md:text-lg text-gray-500 max-w-2xl mx-auto mb-10 transition-all duration-700 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
        >
          {DATA.tagline}
        </p>
        ...
        >
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              {/* Rotating ring */}
              <div className="absolute inset-0 rounded-full border-2 border-dashed border-[#915eff]/30 animate-spin" style={{ animationDuration: "20s" }} />
              ...
              {/* Floating badges */}
              <div className="absolute -top-2 -right-2 bg-[#1a1a2e] border border-[#915eff]/30 rounded-xl px-3 py-1.5 text-xs text-[#915eff] font-semibold shadow-lg animate-bounce" style={{ animationDuration: "3s" }}>
                React.js ⚛️
              </div>
              <div className="absolute -bottom-2 -left-2 bg-[#1a1a2e] border border-emerald-500/30 rounded-xl px-3 py-1.5 text-xs text-emerald-400 font-semibold shadow-lg animate-bounce" style={{ animationDuration: "4s", animationDelay: "0.5s" }}>
                Python 🐍
              </div>
            </div>
          </div>
  ...
  return (
    <section id="skills" className="py-24 bg-[#0a0a1a] px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          ref={ref}
          className="mt-16 grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5"
        >
          {DATA.skills.map((skill, i) => (
            <div
              key={skill.category}
              className={`group relative bg-[#1a1a2e] border border-white/6 rounded-2xl p-5 hover:border-[#915eff]/30 hover:bg-[#1e1e3a] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(145,94,255,0.1)] ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
                }`}
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-sm font-semibold text-[#915eff] mb-3 uppercase tracking-wider">
                  {skill.category}
                </h3>
    ...
    <section id="projects" className="py-24 bg-[#050816] px-6">
      <div className="max-w-7xl mx-auto">
        <SectionHeader
          ...
          subtitle="What I've built — real-world applications with modern tech"
        />
        ...
        <div ref={ref} className="mt-16 grid md:grid-cols-2 gap-8">
          {DATA.projects.map((project, i) => (
            <div
              key={project.id}
              className={`group relative bg-[#1a1a2e] border border-white/6 rounded-3xl overflow-hidden hover:border-[#915eff]/20 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(0,0,0,0.4)] cursor-pointer ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
            ...
            >
              ...
              <div className="p-7">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r ${project.gradient} border ${project.border} text-xs font-semibold text-gray-300 mb-3`}>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={ref} className="mt-16 grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {DATA.achievements.map((ach, i) => (
            <div
              key={i}
              className={`group relative bg-[#1a1a2e] border border-white/6 rounded-2xl p-7 overflow-hidden hover:border-white/10 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] ${inView ? "opacity-100 scale-100" : "opacity-0 scale-95"
                }`}
              style={{ transitionDelay: inView ? `${i * 150}ms` : "0ms" }}
            >
...
function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    /* In production wire to a backend / EmailJS / Formspree */
    setSent(true);
          ...
          <div>
            ...
            <div className="space-y-4">
              {contactLinks.map((link) => (
                ...
                >
                  <div className="w-10 h-10 bg-[#915eff]/10 rounded-lg flex items-center justify-center text-lg flex-shrink-0">
                    {link.icon}
                  </div>
                  <div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-gray-600 text-center">
            © {new Date().getFullYear()} Shubham Kadam. Built with React & ❤️
          </p>
